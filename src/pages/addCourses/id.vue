      ...
      <div class="row g-5">
        ...
        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
          <h6 class="section-title bg-white text-start text-primary pe-3">
            Кыска мөөнөттүү кошумча ийримдер
          </h6>
          <h1 class="mb-4">Профессионал ашпозчу</h1>
          <p>
          ...
          <div class="row gy-2 gx-4 mb-4">
            <div class="col-sm-6">
              <p class="mb-0">
                <i class="fa fa-arrow-right text-primary me-2"></i>Окуу мөөнөтү
                3 ай
              </p>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-sm-6">
              <p class="mb-0">
                <i class="fa fa-arrow-right text-primary me-2"></i>12 өлкөдө
                жарактуу диплом берилет
              </p>
            </div>
          </div>
        </div>
